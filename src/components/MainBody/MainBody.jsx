...
function MainBody() {
  ...
  return (
    <div>
      <div className={styles["input-rules-box-wrapper"]}><Instruction/></div>
      <div className={styles["search-box-wrapper"]}>
        ...
        />
        <Button onClick={fetchRecipeData} disabled={submitLoading}>
